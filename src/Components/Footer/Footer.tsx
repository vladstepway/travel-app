...
const Footer = function() {
  return <div className={styles.footer}><span className='footer__year'>2021</span>
    ...
    <a className='footer__author-link' href='https://github.com/SixStringer91' target='_blank'>Ilya Barachenia</a>
    <a className='footer__author-link' href='https://github.com/juliememe' target='_blank'>Danik Lutsev</a>
