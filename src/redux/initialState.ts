  ...
  countries: [
    ...
    },
    {
      ...
      details: {
        ...
        videoURL: '',
        mapCoords: {
          center: { latitude: 23.6448, longitude: 77.216721 },
          capital: { latitude: 28.6139, longitude: 77.20901 },
        },
      },
      photo:
    ...
    },
    {
      ...
      details: {
        ...
        mapCoords: {
          ...
          capital: { latitude: 9.06433, longitude: 7.4893 },
        },
      },
      photo:
        ...
        views: [
          {
            ...
            about:
              'amounting to a total land area of about 18,300 square kilometres (7,100 sq mi). The mo',
          },
          {
            imgURL:
          ...
          },
          {
            ...
            viewName: 'Puprik',
            about:
              ' 13th-largest country by area; with approximately 126,014,024 inhabitants, it is 10th',
          },
        ],
    ...
    },
    {
      ...
      details: {
        info:
          'Mexico is a country in the southern portion of North America. It is bordered to the north by the United States; to the south and west by the Pacific Ocean;' +
